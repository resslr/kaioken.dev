...
import { useFormReturnTypePreview } from "$/components/previews/UseFormReturn.type.preview"
...
<HighlightOnLoad id="basic-usage">
  ...
  configuration object and returns a <CodePreview data={useFormReturnTypePreview} /> that provides:
  ...
  - **state**: Current form state including values, errors, and validation status
