...
function getResolvedColor(props: ButtonProps) {
  // Works whether `props.color` is a string or a Signal<string>
  return unwrap(props.color, true)
}
```
