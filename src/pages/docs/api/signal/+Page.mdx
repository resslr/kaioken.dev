...
{siteCodeLang.value === "ts" ? <ExternalSignalExampleTS /> : <ExternalSignalExample />}
...
{siteCodeLang.value === "ts" ? <SignalToChildExampleTS /> : <SignalToChildExample />}
...
{siteCodeLang.value === "ts" ? <NotifyExampleTS /> : <NotifyExample />}