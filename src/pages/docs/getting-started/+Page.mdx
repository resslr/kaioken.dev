...
<div className="no-prose">
  <span>Update your vite.config.ts to add JSX settings and the HMR plugin:</span>
...
<div className="no-prose">
  ...
  <CodeBlock code={`import { mount } from "kaioken"
import { App } from "./App"
...
Reach out to us or get involved on <ExternalLink href="https://discord.com/channels/1206182768342597684/1210408910159351818">Discord</ExternalLink>
